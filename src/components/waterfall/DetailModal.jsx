...
import { 
  ArrowLeft, Share2, Heart, Star, MapPin, Clock, Waves, Footprints, DollarSign, ChevronDown, Navigation, X 
} from 'lucide-react';
...
export default function DetailModal({ waterfall, onClose, isSaved, onToggleSave }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex justify-center items-end sm:items-center animate-fade-in overflow-hidden">
      <div className="bg-[#0B1515] w-full max-w-[480px] h-[95vh] sm:h-[90vh] rounded-t-[36px] sm:rounded-[36px] overflow-hidden flex flex-col border border-white/10 shadow-2xl relative animate-slide-up">
        
        {/* Top Floating Header Buttons */}
        <div className="absolute top-5 left-5 right-5 z-20 flex items-center justify-between pointer-events-none">
          <button
            onClick={onClose}
            className="p-2.5 rounded-full bg-black/50 backdrop-blur-md text-white border border-white/10 hover:bg-black/80 pointer-events-auto transition-all"
          >
            <ArrowLeft size={18} />
          </button>

          <div className="flex items-center gap-2 pointer-events-auto">
            <button className="p-2.5 rounded-full bg-black/50 backdrop-blur-md text-white border border-white/10 hover:bg-black/80 transition-all">
              <Share2 size={18} />
            </button>
            <button
              onClick={() => onToggleSave(waterfall.id)}
              className={`p-2.5 rounded-full backdrop-blur-md border transition-all ${
                isSaved ? 'bg-[#E5A967] text-[#0B1515] border-[#E5A967]' : 'bg-black/50 text-white border-white/10'
              }`}
            >
        ...
        <div className="flex-1 overflow-y-auto pb-28">
          ...
          <div className="relative h-80 w-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#0B1515] via-transparent to-black/40"></div>
          </div>
          ...
          <div className="p-6 space-y-6 -mt-6 relative z-10">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="glass-card p-4 rounded-2xl bg-[#132222]/80 border border-white/10 flex flex-col items-start gap-1">
            ...
            <div>
              ...
              <button
                ...
                className="mt-1 text-xs font-bold text-[#E5A967] flex items-center gap-1 hover:underline"
              >
            ...
            <div>
              ...
              <div className="relative rounded-2xl overflow-hidden h-44 border border-white/10 bg-[#132222] shadow-inner flex items-center justify-center">
                {/* Topographic Map Style Canvas */}
                ...
                <div className="relative z-10 flex flex-col items-center">
                  <div className="w-10 h-10 rounded-full bg-[#E5A967] text-[#0B1515] flex items-center justify-center font-bold shadow-lg shadow-[#E5A967]/30 border-2 border-white">
                    <MapPin size={20} />
                  </div>
        ...
        <div className="absolute bottom-4 left-5 right-5 z-30">
          <a
            ...
            className="w-full py-4 rounded-full bg-[#E5A967] text-[#0B1515] font-black text-sm flex items-center justify-center gap-2 shadow-2xl shadow-[#E5A967]/30 hover:bg-[#d69755] transition-all tracking-wider uppercase"
          >
            <Navigation size={18} />
